class FileTreeItemContents
{
	private java.io.File mValue;
	
	public FileTreeItemContents(java.io.File value)
	{
		this.mValue = value;
	}
	...
	{
		String[] path = mValue.getPath().split("/");
...
//                        = new javafx.scene.control.TreeItem<java.io.File>(f, new javafx.scene.image.ImageView(actpropsIcon));
        ...
        public void cancelEdit() {
			...
			String[] pathParts = ((String)getItem().getPath()).split("/");
            setText(pathParts[pathParts.length - 1]);
