...
public class LZWBinfa
{
	...
	{
		printTreeInternal(this.getRootNode(), 0);
	}
	
	private void printTreeInternal(Node pos, int depth)
	{
		if(pos.getLeftChild() != null)
		{
			printTreeInternal(pos.getLeftChild(), depth + 1);
		}
		...
		{
			printTreeInternal(pos.getRightChild(), depth + 1);
		}
	}
